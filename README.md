# Посмотреть можно [здесь](https://crm.vladislavsurin.ru) (для полноценной работы требуется запуск сервера. Инструкция ниже.)

# REST API для базы данных клиентов

Перед запуском убедитесь, что вы установили Node.js версии 12 или выше.

Для запуска сервера перейдите в папку `crm-backend` репозитория и выполните команду `node index`. Для остановки нажмите сочетание клавиш CTRL+C.

После запуска сервера API будет доступен по пути `http://localhost:3500`.
